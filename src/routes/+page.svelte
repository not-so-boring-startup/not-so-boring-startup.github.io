          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="@container">
              <div class="@[480px]:p-4">
                <div
                  ...
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuDMboi1sKVpobQ4Q6YmFNSF4L0GzJIniMhYTwd7z0ByDDuO3AbiVeoHGZQ1GXLK2i9kYU0_2Hul5-PNPNHYU0XdLyQrasjubFCEUndf63JraXiah8C83_vR-gwiToH7g7eb0dOK07H_AYQOqqNwCbgDHfS4PvxQV8sOyykQEtnUdRX533RfbNQm1tTIxmtFGkQHFHamzR9qLLhAXDgpfb-p7VjFUR4chaFuYF_3CIjLVt3D77Qd9LO7FIXez32k4ZO3kmtyPTTxIH2f");'
                >
                  <div class="flex flex-col gap-2 text-center">
                    <h1
                      class="text-white text-4xl font-black leading-tight tracking-[-0.033em] @[480px]:text-5xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em]"
                    >
                      Unleash Your Potential with Not So Boring Startup
                    </h1>
                    <h2 class="text-white text-sm font-normal leading-normal @[480px]:text-base @[480px]:font-normal @[480px]:leading-normal">
                      Transform your ideas into reality with our intuitive software. Start your free trial today and experience the difference.
                    </h2>
                  </div>
            ...
            <div class="flex flex-col gap-10 px-4 py-10 @container">
              <div class="flex flex-col gap-4">
                ...
                <p class="text-[#0e141b] text-base font-normal leading-normal max-w-[720px]">
                  Our software is packed with features designed to help you succeed. Here are some of the highlights:
                </p>
              </div>
              <div class="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div class="flex flex-1 gap-3 rounded-lg border border-[#d0dbe7] bg-slate-50 p-4 flex-col">
                  <div class="text-[#0e141b]" data-icon="AppWindow" data-size="24px" data-weight="regular">
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0e141b] text-base font-bold leading-tight">Intuitive Interface</h2>
                    <p class="text-[#4e7397] text-sm font-normal leading-normal">
                      Our user-friendly interface makes it easy to get started and navigate the software, even for beginners.
                    </p>
                  </div>
                </div>
                <div class="flex flex-1 gap-3 rounded-lg border border-[#d0dbe7] bg-slate-50 p-4 flex-col">
                  <div class="text-[#0e141b]" data-icon="CursorClick" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0e141b] text-base font-bold leading-tight">Powerful Tools</h2>
                    <p class="text-[#4e7397] text-sm font-normal leading-normal">
                      Access a wide range of powerful tools and functionalities to streamline your workflow and boost productivity.
                    </p>
                  </div>
                </div>
                <div class="flex flex-1 gap-3 rounded-lg border border-[#d0dbe7] bg-slate-50 p-4 flex-col">
                  <div class="text-[#0e141b]" data-icon="UsersThree" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0e141b] text-base font-bold leading-tight">Collaborative Workspaces</h2>
                    <p class="text-[#4e7397] text-sm font-normal leading-normal">
                      Collaborate seamlessly with your team in shared workspaces, ensuring everyone stays on the same page.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="grid grid-cols-[repeat(auto-fit,minmax(228px,1fr))] gap-2.5 px-4 py-3 @3xl:grid-cols-4">
              <div class="flex flex-1 flex-col gap-4 rounded-lg border border-solid border-[#d0dbe7] bg-slate-50 p-6">
                <div class="flex flex-col gap-1">
                  <h1 class="text-[#0e141b] text-base font-bold leading-tight">Basic</h1>
                  <p class="flex items-baseline gap-1 text-[#0e141b]">
                    <span class="text-[#0e141b] text-4xl font-black leading-tight tracking-[-0.033em]">$5</span>
              ...
              <div class="flex flex-1 flex-col gap-4 rounded-lg border border-solid border-[#d0dbe7] bg-slate-50 p-6">
                <div class="flex flex-col gap-1">
                  <h1 class="text-[#0e141b] text-base font-bold leading-tight">Pro</h1>
                  <p class="flex items-baseline gap-1 text-[#0e141b]">
              ...
              <div class="flex flex-1 flex-col gap-4 rounded-lg border border-solid border-[#d0dbe7] bg-slate-50 p-6">
                <div class="flex flex-col gap-1">
                  <h1 class="text-[#0e141b] text-base font-bold leading-tight">Enterprise</h1>
                  <p class="flex items-baseline gap-1 text-[#0e141b]">
                    <span class="text-[#0e141b] text-4xl font-black leading-tight tracking-[-0.033em]">Let's talk!</span>
                    <span class="text-[#0e141b] text-base font-bold leading-tight"></span>
                  </p>
                </div>
                <button
                  class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#e7edf3] text-[#0e141b] text-sm font-bold leading-normal tracking-[0.015em]"
            ...
            <div class="flex flex-col gap-8 overflow-x-hidden bg-slate-50 p-4">
              ...
              <div class="flex flex-col gap-3 bg-slate-50">
                <div class="flex items-center gap-3">
                  ...
                  ></div>
                  <div class="flex-1">
                    <p class="text-[#0e141b] text-base font-medium leading-normal">{testimonial.name}</p>
                    <p class="text-[#4e7397] text-sm font-normal leading-normal">{testimonial.position}</p>
                  </div>
                </div>
                <div class="flex gap-0.5">
                  {#each Array(5) as _, i}
                    <div class={i < testimonial.rating ? "text-[#197fe5]" : "text-[#aec2d5]"} data-icon="Star" data-size="20px" data-weight={i < testimonial.rating ? "fill" : "regular"}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                        <path
