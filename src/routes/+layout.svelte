            ...
            <footer class="flex flex-col gap-6 px-5 py-10 text-center @container">
              ...
              <div class="flex flex-wrap justify-center gap-4">
                <a href="x.com/notboringstartup" aria-label="Twitter">
                  <div class="text-[#4e7397]" data-icon="TwitterLogo" data-size="24px" data-weight="regular">
                ...
                <a href="https://www.facebook.com/notboringstartup" aria-label="Facebook">
                  <div class="text-[#4e7397]" data-icon="FacebookLogo" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                ...
                <a href="https://www.instagram.com/notboringstartup/" aria-label="Instagram">
                  <div class="text-[#4e7397]" data-icon="InstagramLogo" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
